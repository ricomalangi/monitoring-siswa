<div class="row">
    <div class="col-xl-12 mb-4">
        <div class="card shadow h-100">
            <div class="card-header">Detail Guru BK</div>
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="<?= $input->nama_bk ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Agama</label>
                    ...
                    <div class="form-group col-md-6">
                        <label>NIP</label>
                        <input type="number" class="form-control" value="<?= $input->nip ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
